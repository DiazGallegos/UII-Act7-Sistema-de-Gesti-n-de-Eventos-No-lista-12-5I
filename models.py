...
class Ticket(models.Model):
    ...
    def __str__(self):
        return f"Ticket {self.id_ticket} - {self.id_participante}"
...
class Evento_Patrocinador(models.Model):
    ...
    def __str__(self):
        return f"{self.id_evento} - {self.id_patrocinador}"
...
class Feedback_Evento(models.Model):
    ...
    def __str__(self):
        return f"Feedback {self.id_feedback} - {self.id_participante}"
